...
class ShortestToHighestBlockLogic(BaseLogic):
    def __init__(self):
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        for diamond in diamonds:
            ...
            temp.append((diamond[0], surrounding_points, diamond[1], distance, surrounding_points))
        sorted_temp = sorted(temp, key=lambda x: (-x[1], x[3]))
