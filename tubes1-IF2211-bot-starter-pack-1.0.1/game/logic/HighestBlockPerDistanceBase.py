...
class HighestBlockPerDistanceBaseLogic(BaseLogic):
    def __init__(self):
    ...
    def calculate_benefit(self, point: int, diamond_distance_to_base: int) -> float :
        if diamond_distance_to_base == 0:
            return 0
        else :
            return (point / diamond_distance_to_base) * 100000
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        for diamond in diamonds:
            ...
            benefit = self.calculate_benefit(surrounding_points, diamond_distance_to_base)
