...
class ShortestToBaseLogic(BaseLogic):
    def __init__(self):
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        for diamond in diamonds:
            distance = self.get_distance(board_bot.properties.base, diamond[0])
            distance_from_bot = self.get_distance(board_bot.position, diamond[0])
            temp.append((diamond[0], diamond[1], distance_from_bot, distance))
